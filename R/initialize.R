#' @title create_input
#'
#' @description This function creates an object of class nmf_input, later passed to the solve_nmf
#' function.
#'
...
#' arguments
#'
#' @examples my_input = create_input(Romeo_and_Juliet_tdm, rownames(Romeo_and_Juliet_tdm),
#'    topics = 10)
#'
#' @export
