...
ggpubr::ggarrange(ols_fit_juliet,
                  ols_fit_dead,
                  ncol = 1, nrow = 2)
...
ggpubr::ggarrange(beta_asymptotic_juliet,
                  beta_asymptotic_dead,
                  ncol = 1, nrow = 2)
...
beta_asymptotic_juliet_newdata <- brett_plot(beta_asymptotic,
                                             topic = "juliet",
                                             newdata = newdata)
beta_asymptotic_dead_newdata <- brett_plot(beta_asymptotic,
                                           topic = "dead",
                                           newdata = newdata)
ggpubr::ggarrange(beta_asymptotic_juliet_newdata,
                  beta_asymptotic_dead_newdata,
                  ncol = 1, nrow = 2)
...
ggpubr::ggarrange(beta_asymptotic_juliet_newdata,
                  beta_boot_juliet,
                  beta_boot_juliet_newdata,
                  beta_asymptotic_dead_newdata,
                  beta_boot_dead,
                  beta_boot_dead_newdata,
                  ncol = 3, nrow = 2)
```
